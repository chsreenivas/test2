...
/**
 * This Test Case verifies adding of Speakers
 * reference Test rail-iConnect_EMT(Create Speakers)
 */
...
public class AddSpeaker extends BusinessFunctions {
	public static int logIn=0;
	
	@Test(dataProvider = ("getData"),groups= {"EMT", "RunAll"})
	public void EMT_AddSpeakers(String prefix,String CustomerParticipantID,String FirstName,String status,
		...
		if(click(By.xpath("//div[h2[text()='Speakers']]/following-sibling::div/div/table/tbody/tr/td[text()='"+Email+"']"),Email))
		{
	...
	public Object[][] getData() throws Exception {
		return Data_Provider.getTableArray("EMTAddSpeaker", "Key_AddSpeaker");  //returning data from "EMTAddSpeaker" sheet and "Key_AddSpeaker" as a reference to read data
	}
